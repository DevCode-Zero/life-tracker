      ...
      <CardContent className="space-y-3">
        ...
        {todayMeals.map((meal) => {
          ...
          return (
            <div
              key={meal.id}
              className="group flex justify-between items-start bg-zinc-950/50 p-2 rounded-lg border border-transparent hover:border-zinc-800 transition-all"
            >
                ...
                <div>
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="opacity-0 group-hover:opacity-100 p-0.5 hover:text-red-400 text-zinc-700 transition-all"
                    >
        ...
        {todayMeals.length > 0 && (
          <div className="flex justify-between pt-2 border-t border-zinc-800 text-xs font-semibold">
            ...
            <span className="text-white">
              {Math.round(totalCalories)} kcal · {Math.round(totalProtein)}g
              protein
            </span>
          </div>
        )}
